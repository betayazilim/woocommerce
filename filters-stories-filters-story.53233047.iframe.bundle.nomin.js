(self["webpackChunk_woocommerce_storybook"] = self["webpackChunk_woocommerce_storybook"] || []).push([[911,1478,5190,9048],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+compose@7.45.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-previous/index.mjs
var use_previous = __webpack_require__("../../node_modules/.pnpm/@wordpress+compose@7.45.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-previous/index.mjs");
...
/***/ "../../node_modules/.pnpm/@wordpress+compose@7.45.0_react@18.3.1/node_modules/@wordpress/compose/build-module/hooks/use-previous/index.mjs":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+viewport@6.33.1_react@18.3.1/node_modules/@wordpress/viewport/build-module/index.js + 26 modules
var viewport_build_module = __webpack_require__("../../node_modules/.pnpm/@wordpress+viewport@6.33.1_react@18.3.1/node_modules/@wordpress/viewport/build-module/index.js");
...
CompareFilter.displayName = "CompareFilter";
...
ComparePeriods.displayName = "ComparePeriods";
...
PresetPeriods.displayName = "PresetPeriods";
...
DateRangeFilterPicker.displayName = "DateRangeFilterPicker";
...
class FilterPicker extends _wordpress_element__WEBPACK_IMPORTED_MODULE_4__.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("div", {
      className: "woocommerce-filters-filter",
      children: [config.label && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsxs)("span", {
        className: "woocommerce-filters-label",
...
SegmentedSelection.displayName = "SegmentedSelection";
...
/* harmony import */ var _wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("../../node_modules/.pnpm/@wordpress+i18n@6.6.1/node_modules/@wordpress/i18n/build-module/index.js");
/* harmony import */ var qs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("../../node_modules/.pnpm/qs@6.15.1/node_modules/qs/lib/index.js");
...
const presetValues = [{
  value: 'today',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Today', 'woocommerce')
}, {
  value: 'yesterday',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Yesterday', 'woocommerce')
}, {
  value: 'week',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Week to date', 'woocommerce')
}, {
  value: 'last_week',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Last week', 'woocommerce')
}, {
  value: 'month',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Month to date', 'woocommerce')
}, {
  value: 'last_month',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Last month', 'woocommerce')
}, {
  value: 'quarter',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Quarter to date', 'woocommerce')
}, {
  value: 'last_quarter',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Last quarter', 'woocommerce')
}, {
  value: 'year',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Year to date', 'woocommerce')
}, {
  value: 'last_year',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Last year', 'woocommerce')
}, {
  value: 'custom',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Custom', 'woocommerce')
}];
const periods = [{
  value: 'previous_period',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Previous period', 'woocommerce')
}, {
  value: 'previous_year',
  label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Previous year', 'woocommerce')
}];
...
function getRangeLabel(after, before) {
  ...
  const fullDateFormat = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('MMM D, YYYY', 'woocommerce');
  if (isSameDay) {
    return after.format(fullDateFormat);
  } else if (isSameMonth) {
    const afterDate = after.date();
    return after.format(fullDateFormat).replace(String(afterDate), `${afterDate} - ${before.date()}`);
  } else if (isSameYear) {
    const monthDayFormat = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('MMM D', 'woocommerce');
 ...
 * @return {DateValue} - DateValue data about the selected period
 */
const getDateValue = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.memoize)((period, compare, after, before) => {
  switch (period) {
    case 'today':
 ...
 */
const getDateParamsFromQueryMemoized = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.memoize)((period, compare, after, before, defaultDateRange) => {
  if (period && compare) {
    return {
      period,
      compare,
  ...
  const queryDefaults = (0,qs__WEBPACK_IMPORTED_MODULE_4__.parse)(defaultDateRange.replace(/&amp;/g, '&'));
 ...
 */
const getCurrentDatesMemoized = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.memoize)((period, compare, primaryStart, primaryEnd, secondaryStart, secondaryEnd) => {
  const primaryItem = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.find)(presetValues, item => item.value === period);
  if (!primaryItem) {
    throw new Error(`Cannot find period: ${period}`);
  }
  const secondaryItem = (0,lodash__WEBPACK_IMPORTED_MODULE_2__.find)(periods, item => item.value === compare);
  if (!secondaryItem) {
...
const dateValidationMessages = {
  invalid: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Invalid date', 'woocommerce'),
  future: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Select a date in the past', 'woocommerce'),
  startAfterEnd: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Start date must be before end date', 'woocommerce'),
  endBeforeStart: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Start date must be before end date', 'woocommerce')
};
